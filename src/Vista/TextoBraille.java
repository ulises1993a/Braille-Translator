...
public class TextoBraille  extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        Ingresado = new javax.swing.JTextArea();
        ...
        Ingresado.setColumns(20);
        Ingresado.setFont(new java.awt.Font("Arial", 0, 30)); // NOI18N
        Ingresado.setLineWrap(true);
        Ingresado.setRows(5);
        Ingresado.setWrapStyleWord(true);
        IntroducirTexto.setViewportView(Ingresado);

        BackGround.add(IntroducirTexto, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 170, 580, 210));
        ...
        BackGround.add(TextTraducido, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 520, 580, 210));
        ...
        BackGround.add(Traducir, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 400, 250, 90));
        ...
        BackGround.add(BrailleTexto, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 470, 300, 80));
        ...
        Fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/TextoBraille.png"))); // NOI18N
    ...
    private void TraducirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TraducirMouseClicked
        ...
        String textoingresado = Ingresado.getText();
        String textoresultado = listener.TextToBrialle(textoingresado);

        Resultado.setText(textoresultado);   
    }//GEN-LAST:event_TraducirMouseClicked
    
    private void misComponentes(){
        this.setTitle("Texto a Braille");
        this.setLocationRelativeTo(null);
        this.setResizable(false);
        this.setVisible(true);
        Font font = new Font("Code2000", Font.PLAIN, 36);
        Ingresado.setFont(font);
    ...
    private javax.swing.JTextArea Ingresado;
