...
public class ImagenBraille extends javax.swing.JFrame {
    
    public ImagenBraille() {
        initComponents();
        misComponentes();
    }
    ...
    private void initComponents() {
        ...
        Fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ImagenBrailla.png"))); // NOI18N
    ...
    private void VozBrailleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_VozBrailleMouseClicked
        VozBraille vetana = new VozBraille();
        this.dispose();
    }//GEN-LAST:event_VozBrailleMouseClicked
    
    private void misComponentes(){
        this.setTitle("Imagen a Braille");
